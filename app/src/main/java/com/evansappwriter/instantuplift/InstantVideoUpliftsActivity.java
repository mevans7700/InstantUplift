...
public class InstantVideoUpliftsActivity extends InstantUpliftActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//layout.setBackgroundDrawable(getResources().getDrawable(R.drawable.ruinsbk));
		
		TextView title = (TextView)findViewById(R.id.menu_title);
		title.setText(getResources().getString(R.string.uplift_title));
	...
	void initList() {
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.bluesunicon),
				getResources().getString(R.string.uplift_menu_item_1),
				getResources().getString(R.string.uplift_menu_item_1a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.orangesunicon),
				getResources().getString(R.string.uplift_menu_item_2),
				getResources().getString(R.string.uplift_menu_item_2a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.handsunicon),
				getResources().getString(R.string.uplift_menu_item_3),
				getResources().getString(R.string.uplift_menu_item_3a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.leaficon),
				getResources().getString(R.string.uplift_menu_item_4),
				getResources().getString(R.string.uplift_menu_item_4a)));	
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.bluesunicon),
				getResources().getString(R.string.uplift_menu_item_5),
				getResources().getString(R.string.uplift_menu_item_5a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.orangesunicon),
				getResources().getString(R.string.uplift_menu_item_6),
				getResources().getString(R.string.uplift_menu_item_6a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.handsunicon),
				getResources().getString(R.string.uplift_menu_item_7),
				getResources().getString(R.string.uplift_menu_item_7a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.leaficon),
				getResources().getString(R.string.uplift_menu_item_8),
				getResources().getString(R.string.uplift_menu_item_8a)));
	}
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        openBrowser(mInstantVideoUplifts[position]);        
    }
