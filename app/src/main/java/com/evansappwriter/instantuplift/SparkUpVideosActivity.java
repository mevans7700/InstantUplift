...
public class SparkUpVideosActivity extends InstantUpliftActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//layout.setBackgroundDrawable(getResources().getDrawable(R.drawable.winterbk));
		
		TextView title = (TextView)findViewById(R.id.menu_title);
		title.setText(getResources().getString(R.string.sparkup_title));
	...
	void initList() {
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.bluesunicon),
				getResources().getString(R.string.sparkup_menu_item_1),
				getResources().getString(R.string.sparkup_menu_item_1a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.orangesunicon),
				getResources().getString(R.string.sparkup_menu_item_2),
				getResources().getString(R.string.sparkup_menu_item_2a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.handsunicon),
				getResources().getString(R.string.sparkup_menu_item_3),
				getResources().getString(R.string.sparkup_menu_item_3a)));
		mMenuList.add(new DisplayItem(getResources().getDrawable(R.drawable.leaficon),
				getResources().getString(R.string.sparkup_menu_item_4),
				getResources().getString(R.string.sparkup_menu_item_4a)));			
	}
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        openBrowser(mSparkUpVideos[position]);        
    }
